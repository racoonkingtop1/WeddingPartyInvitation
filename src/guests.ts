...
export const GUESTS: Guest[] = [
  ...
  {
    id: transliterate('Руслан'),
    name: 'Руслан',
    role: 'guest',
    title: 'Отдыхающий',
    blurb: 'Бро, ты итак уже очень много сделал. Мы рады, что комиссариат сжалился и отпустил тебя погулять на нашей свадьбе. Просто кайфуй и постарайся отдохнуть — для нас это важно. Бро, ты выживешь и т.д.',
  },
  {
    id: transliterate('Роман'),
    name: 'Роман',
    role: 'host',
    title: 'Ведун',
    blurb: 'Ну шо Роман... Волк не тот, кто волк, а тот, кто гулять. Ты у нас ведущий, так что не балуйся (без нас). Если всё чётко проведёшь — в благодарность отдадим тебе паспорт. Ну всё в общем. Борьба. Бросок. Связь.',
  },
];
