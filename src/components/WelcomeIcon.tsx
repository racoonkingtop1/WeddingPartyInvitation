// Welcome-card mascot icon (FontAwesome "person-circle-question"),
// recolored from its original orange to the redesign's blue accent.
export default function WelcomeIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className={className} role="img" aria-label="Иконка гостя">
      <path
        fill="var(--color-blue)"
