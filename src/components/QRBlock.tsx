...
export default function QRBlock() {
  return (
    <section
      ...
      style={{ background: 'linear-gradient(180deg, var(--color-cream) 0%, var(--color-navy) 20%, #142434 100%)' }}
    >
      <div
      ...
      <ScrollReveal>
        ...
        <div className="relative w-40 h-40 mx-auto rounded-2xl border-2 border-dashed border-white/25 glass-dark flex flex-col items-center justify-center gap-2">
